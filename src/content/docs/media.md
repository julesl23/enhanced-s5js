...
description: 'Client-side thumbnail generation, image metadata extraction, and progressive rendering.'
---
...
- **[Advanced CID API](/advanced-cid/)** - Content-addressed storage for media
- **[Performance & Scaling](/performance/)** - Optimize large image galleries
- **[Directory Utilities](/utilities/)** - Batch process image directories
