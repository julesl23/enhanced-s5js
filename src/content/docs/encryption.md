---
title: 'Encryption'
description: 'XChaCha20-Poly1305 authenticated encryption for files at rest.'
---
...
```typescript
import { DirectoryWalker, BatchOperations } from '@julesl23/s5js';
...
- **[Advanced CID API](/advanced-cid/)** - Content verification
- **[API Reference](/api-reference/)** - Complete API documentation
- **[S5 Encryption Spec](https://docs.sfive.net/spec/encryption.html)** - Technical details
